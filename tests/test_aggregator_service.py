...
from app.core.aggregator_service import aggregate
...
@pytest.mark.parametrize(["dt_from", "dt_upto", "group_type", "exp"], [
    # [
    #     datetime.datetime.fromisoformat("2022-09-01T00:00:00"),
    #     datetime.datetime.fromisoformat("2022-12-31T23:59:00"),
    #     GroupType.month.value,
    #     {"dataset": [5906586, 5515874, 5889803, 6092634],
    #      "labels": ["2022-09-01T00:00:00", "2022-10-01T00:00:00", "2022-11-01T00:00:00", "2022-12-01T00:00:00"]}
    # ],
    [
        datetime.datetime.fromisoformat("2022-10-01T00:00:00"),
        datetime.datetime.fromisoformat("2022-11-30T23:59:00"),
        GroupType.day.value,
    ...
    [
        ...
        datetime.datetime.fromisoformat("2022-02-02T00:00:00"),
        GroupType.hour.value,
...
def test_aggregator_service(get_mongo_client, dt_from, dt_upto, group_type, exp):
    collection = get_mongo_client["sample_collection"]
    rec = aggregate(dt_from, dt_upto, group_type, collection)
    assert rec == exp
